...
- "Belief" "Y" for if their  
# 3. Statistical Analysis 
## 3.1 Primary Analysis
Using the final dataset, we fit a binomial regression. The model used "Belief" as the outcome (y) variable while adjusting for Age, Gender, MH , PH, 
