...
1. Binomial Regression to assess whether individuals with on-going issues believe their condition will get worse while waiting for treatment

2. Assess prevalance of health issues in the cohort; adjusting for other factors

3. Assess how representative the sample is compared to the population 
...
# Prevalence = number of people with the condition ÷ total number of people in the cohort
